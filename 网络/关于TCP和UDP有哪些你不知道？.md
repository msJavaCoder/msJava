...
![img](https://s0.lgstatic.com/i/image/M00/27/2D/CgqCHl70ccOALHS1AADhgTvLn9Q814.png)
...
- 效率TCP 和 UDP 的使用场景如下图所示：，TCP 的传输效率较低，而 UDP 的传输效率较高；
...
![image-20200626154543640](C:\Users\孙白胖的爸爸\AppData\Roaming\Typora\typora-user-images\image-20200626154543640.png)

## 总结

上文我们介绍了 TCP 三个特点：面向连接、可靠性和面向字节流，其中可靠性主要是依赖它的状态记录和根据实际情况调整自身的行为方式。例如，当 TCP 意识到丢包时就会重发此包，这样就保证了通信的可靠性。
